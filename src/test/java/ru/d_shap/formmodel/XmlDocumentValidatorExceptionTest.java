...
/**
 * Tests for {@link XmlDocumentValidatorException}.
 *
 * @author Dmitry Shapovalov
 */
public final class XmlDocumentValidatorExceptionTest extends BaseFormModelTest {

    /**
     * Test class constructor.
     */
    public XmlDocumentValidatorExceptionTest() {
        super();
    }
    ...
    public void errorMessageTest() {
        ...
        Assertions.assertThat(new XmlDocumentValidatorException(new IOException(" "))).hasMessage(" ");
        Assertions.assertThat(new XmlDocumentValidatorException(new IOException("io error"))).hasMessage("io error");
    }
