 ...
 */
public final class ElementDefinitionTest {
    ...
    public void getIdTest() {
        Assertions.assertThat(new ElementDefinition(null, "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getId()).isNull();
        Assertions.assertThat(new ElementDefinition("", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getId()).isEqualTo("");
        Assertions.assertThat(new ElementDefinition(" ", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getId()).isEqualTo(" ");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getId()).isEqualTo("id");
    }
    ...
    public void getLookupTest() {
        Assertions.assertThat(new ElementDefinition("id", null, CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getLookup()).isNull();
        Assertions.assertThat(new ElementDefinition("id", "", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getLookup()).isEqualTo("");
        Assertions.assertThat(new ElementDefinition("id", " ", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getLookup()).isEqualTo(" ");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getLookup()).isEqualTo("lookup");
    }
    ...
    public void getCardinalityDefinitionTest() {
        Assertions.assertThat(new ElementDefinition("id", "lookup", null, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isSameAs(CardinalityDefinition.REQUIRED);
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.REQUIRED_MULTIPLE, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isSameAs(CardinalityDefinition.REQUIRED_MULTIPLE);
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.OPTIONAL, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isSameAs(CardinalityDefinition.OPTIONAL);
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.OPTIONAL_MULTIPLE, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isSameAs(CardinalityDefinition.OPTIONAL_MULTIPLE);
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, createNodeDefinitions(), createOtherAttributeNames()).getCardinalityDefinition()).isSameAs(CardinalityDefinition.PROHIBITED);
    }
    ...
    public void getOtherAttributeNamesTest() {
        ...
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames()).getOtherAttributeNames()).isEmpty();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name", "value")).getOtherAttributeNames()).containsExactly("name");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2")).getOtherAttributeNames()).containsExactly("name1", "name2");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeNames()).containsExactly("name1", "name2", "name3");
    }
    ...
    public void getOtherAttributeValueTest() {
        ...
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames()).getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames()).getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames()).getOtherAttributeValue("name")).isNull();

        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name", "value")).getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name", "value")).getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name", "value")).getOtherAttributeValue("name")).isEqualTo("value");

        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue("name")).isNull();
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue("name1")).isEqualTo("value1");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue("name2")).isEqualTo("value2");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.PROHIBITED, null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3")).getOtherAttributeValue("name3")).isEqualTo("value3");
    }
    ...
    public void toStringTest() {
        Assertions.assertThat(new ElementDefinition(null, "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames())).hasToString("element[@]");
        Assertions.assertThat(new ElementDefinition("", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames())).hasToString("element[@]");
        Assertions.assertThat(new ElementDefinition(" ", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames())).hasToString("element[@ ]");
        Assertions.assertThat(new ElementDefinition("id", "lookup", CardinalityDefinition.REQUIRED, createNodeDefinitions(), createOtherAttributeNames())).hasToString("element[@id]");
    }
