 ...
 */
public final class FormDefinitionTest {
    ...
    public void getGroupTest() {
        Assertions.assertThat(new FormDefinition(null, "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getGroup()).isEqualTo("");
        Assertions.assertThat(new FormDefinition("", "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getGroup()).isEqualTo("");
        Assertions.assertThat(new FormDefinition(" ", "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getGroup()).isEqualTo(" ");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getGroup()).isEqualTo("group");
    }
    ...
    public void getIdTest() {
        Assertions.assertThat(new FormDefinition("group", null, createNodeDefinitions(), createOtherAttributeNames(), "source").getId()).isNull();
        Assertions.assertThat(new FormDefinition("group", "", createNodeDefinitions(), createOtherAttributeNames(), "source").getId()).isEqualTo("");
        Assertions.assertThat(new FormDefinition("group", " ", createNodeDefinitions(), createOtherAttributeNames(), "source").getId()).isEqualTo(" ");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getId()).isEqualTo("id");
    }
    ...
    public void getOtherAttributeNamesTest() {
        ...
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames(), "source").getOtherAttributeNames()).isEmpty();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name", "value"), "source").getOtherAttributeNames()).containsExactly("name");
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2"), "source").getOtherAttributeNames()).containsExactly("name1", "name2");
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeNames()).containsExactly("name1", "name2", "name3");
    }
    ...
    public void getOtherAttributeValueTest() {
        ...
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames(), "source").getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames(), "source").getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames(), "source").getOtherAttributeValue("name")).isNull();

        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name", "value"), "source").getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name", "value"), "source").getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name", "value"), "source").getOtherAttributeValue("name")).isEqualTo("value");

        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue(null)).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue("")).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue("name")).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue("name1")).isEqualTo("value1");
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue("name2")).isEqualTo("value2");
        Assertions.assertThat(new FormDefinition("group", "id", null, createOtherAttributeNames("name1", "value1", "name2", "value2", "name3", "value3"), "source").getOtherAttributeValue("name3")).isEqualTo("value3");
    }
    ...
    public void getSourceTest() {
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), null).getSource()).isNull();
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "").getSource()).isEqualTo("");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), " ").getSource()).isEqualTo(" ");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "source").getSource()).isEqualTo("source");
    }
    ...
    public void toStringTest() {
        Assertions.assertThat(new FormDefinition(null, "id", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@:id]");
        Assertions.assertThat(new FormDefinition("", "id", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@:id]");
        Assertions.assertThat(new FormDefinition(" ", "id", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@ :id]");
        Assertions.assertThat(new FormDefinition("group", null, createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@group:]");
        Assertions.assertThat(new FormDefinition("group", "", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@group:]");
        Assertions.assertThat(new FormDefinition("group", " ", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@group: ]");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), null)).hasToString("{}form[@group:id]");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "")).hasToString("{}form[@group:id]");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), " ")).hasToString("{ }form[@group:id]");
        Assertions.assertThat(new FormDefinition("group", "id", createNodeDefinitions(), createOtherAttributeNames(), "source")).hasToString("{source}form[@group:id]");
    }
